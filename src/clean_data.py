...
ABEBEOKS_INPUT = RAW_DIR / "abebooks_raw.csv"
BOOKFINDER_INPUT = RAW_DIR / "bookfinder_amzn_raw.csv"

ABEBOOKS_OUTPUT = PROCESSED_DIR / "abebooks_cleaned.csv"
AMAZON_OUTPUT = PROCESSED_DIR / "amazon_cleaned.csv"
