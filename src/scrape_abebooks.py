...
# ============================================================================
# PATH CONFIGURATION (PROJECT ROOT SAFE)
# ============================================================================
...
ISBN_PATH  = DATA_RAW_DIR / "isbn_seed_1000.csv"
OUT_JSONL  = DATA_RAW_DIR / "abebooks_raw.jsonl"
OUT_CSV    = DATA_RAW_DIR / "abebooks_raw.csv"
...
def main() -> None:
    ...
    if all_rows:
        ...
        print(
            f"[DONE] Saved {len(all_rows)} listings to:\n"
            f"  {OUT_JSONL}\n"
            f"  {OUT_CSV}"
        )
    else:
